...
# Same-directory import; analyzer.py sits next to pipeline.py
...
def analyze(
    ...
    - `noisy_threshold`: rules whose violation_rate (fires / (fires+passes)) exceeds
      this value are surfaced as noisy candidates.
